...
FUNCTION_NAME=QuarkusAmazonLambda
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java${JAVA_MAJOR_VERSION_NUM}
ZIP_FILE=fileb:///Users/p.zajac/workspace/private/experiments/quarkus/quarkus-amazon-lambda/target/function.zip
...
then
  ...
  ZIP_FILE=fileb:///Users/p.zajac/workspace/private/experiments/quarkus/quarkus-amazon-lambda/target/function.zip
  FUNCTION_NAME=QuarkusAmazonLambdaNative
